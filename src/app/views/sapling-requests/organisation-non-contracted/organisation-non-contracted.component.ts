...
@Component({
	selector: 'app-organisation-non-contracted',
	templateUrl: './organisation-non-contracted.component.html',
	styleUrls: ['./organisation-non-contracted.component.scss']
})
export class OrganisationNonContractedComponent extends GlobalListComponent implements OnInit
{

	title = "Non Contracted Organisation"
	tableConfigAndProps = {};
	...
	columnHeader = {
		...
		'dateTime': 'Date', 'typeEn': 'Type', 'quantity': 'Requested Qty', 'contractImage': 'Contract Photo', 'Actions': 'Actions', 'expandable': ''
	};
		...
		protected _route: ActivatedRoute, protected alertService: AlertService,)
	{
		...
		//[ {"key": "typeEn", "value": "nonContractedOrganization"},{"key":"processingStatus","value":"pending"} ]
	...
	{
		this.title = "Non Contracted Organisation"
		this.filterData()
